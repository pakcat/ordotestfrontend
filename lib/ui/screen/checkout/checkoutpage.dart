        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.only(
                left: 7.0.w, right: 7.0.w, bottom: 7.0.w, top: 1.w),
            child: ListView(
              shrinkWrap: true,
              clipBehavior: Clip.none,
              physics: ScrollPhysics(),
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    padding:
                        EdgeInsets.symmetric(vertical: 15.sp, horizontal: 6.sp),
                    decoration: BoxDecoration(
                        color: Colors.white,
                        boxShadow: [
                          BoxShadow(
                ...
                Padding(
                  padding: EdgeInsets.only(
                      top: 5.0.h, left: 5.w, right: 5.w, bottom: 2.h),
                  child: InkWell(
                    child: Container(
                      padding: EdgeInsets.symmetric(
                          horizontal: 12.sp, vertical: 7.5.sp),
                      decoration: ShapeDecoration(
